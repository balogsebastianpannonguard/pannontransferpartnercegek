...
export async function POST(request: Request) {
  try {
    ...
    const user = await findKronesUserByInviteToken(inviteToken, { allowExpired: true });
    ...
    await setKronesTwoFactorEnabled(user._id as ObjectId, true);
