...
export async function POST(request: Request) {
  try {
    ...
    const user = await findSchaefflerUserByInviteToken(inviteToken, { allowExpired: true });
    ...
    await setSchaefflerTwoFactorEnabled(user._id as ObjectId, true);
