...
export async function POST(request: Request) {
  try {
    ...
    const user = await findEccoinoUserByInviteToken(inviteToken, { allowExpired: true });
    ...
    await setEccoinoTwoFactorEnabled(user._id as ObjectId, true);
