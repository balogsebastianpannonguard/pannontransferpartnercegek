...
export async function POST(request: Request) {
  try {
    ...
    const user = await findEnterairUserByInviteToken(inviteToken, { allowExpired: true });
    ...
    await setEnterairTwoFactorEnabled(user._id as ObjectId, true);
