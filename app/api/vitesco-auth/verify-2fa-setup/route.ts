...
export async function POST(request: Request) {
  try {
    ...
    const user = await findVitescoUserByInviteToken(inviteToken, { allowExpired: true });
    ...
    await setVitescoTwoFactorEnabled(user._id as ObjectId, true);
