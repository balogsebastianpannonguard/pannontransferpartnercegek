...
export async function POST(request: Request) {
  try {
    ...
    const user = await findTamaUserByInviteToken(inviteToken, { allowExpired: true });
    ...
    await setTamaTwoFactorEnabled(user._id as ObjectId, true);
