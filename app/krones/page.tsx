...
import KronesPremiumLogin from "./components/KronesPremiumLogin";
import { getPartnerPortalBrand } from "@/lib/partner-portal-brand";

interface KronesPortalUser {
  email: string;
  company?: string;
  role?: string;
}

export default function KronesLandingPage() {
  const { t, language, setLanguage, availableLanguages } = useLanguage();
  const pathname = usePathname();
  const router = useRouter();
  const portalBrand = getPartnerPortalBrand("krones");
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const res = await fetch("/api/krones-auth/session", { cache: "no-store" });
        if (!active) return;
        if (res.ok) {
  ...
  const handleLogout = async () => {
    try {
      await fetch("/api/krones-auth/logout", { method: "POST" });
    } catch {}
    setAuthedUser(null);
  };
      ...
      <div className="relative min-h-screen bg-[#FAFBFC] text-zinc-900 flex flex-col">
        <div className="w-full border-b border-zinc-200/70 bg-white/60 backdrop-blur-md">
          <div className="max-w-6xl mx-auto px-6 h-16 flex items-center">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#003F8A] to-[#002E5F] flex items-center justify-center shadow-sm">
                <span className="text-white font-black text-sm tracking-tighter">C</span>
              </div>
              <div className="flex flex-col">
                <span className="text-[15px] font-bold text-zinc-900 leading-none">KRONES Portál</span>
        ...
        <div className="flex-1 flex items-center justify-center px-4 py-12 sm:py-16">
          <div className="w-full max-w-[440px]">
            ...
            >
              <div className="w-14 h-14 rounded-2xl bg-[#003F8A]/[0.08] border border-[#003F8A]/10 flex items-center justify-center shadow-[0_1px_2px_rgba(15,23,42,0.04)]">
                <Building2 className="w-7 h-7 text-[#003F8A] animate-pulse" />
              </div>
              <div className="flex items-center gap-2.5">
                <motion.div
                  animate={{ rotate: 360 }}
                  transition={{ repeat: Infinity, duration: 1.2, ease: "linear" }}
                  className="w-5 h-5 rounded-full border-2 border-zinc-200 border-t-[#003F8A]"
                />
        ...
        <div className="w-full border-t border-zinc-200/70 bg-white/60 backdrop-blur-md mt-auto">
          <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between text-[11px] text-zinc-400 font-medium">
            ...
            <span className="tracking-wider">KRONES Dedikált Ügyfélportál · Kizárólagos linkalapú hozzáférés</span>
          </div>
        </div>
      </div>
    );
  ...
  if (!authedUser) {
    return <KronesPremiumLogin _onSuccess={setAuthedUser} />;
  }
    ...
    return (
      <div className="fixed inset-0 z-[100] bg-[#020617] flex flex-col items-center justify-center overflow-hidden font-sans">
        ...
        <motion.div 
          ...
          className="absolute w-[800px] h-[800px] bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-[#003F8A]/20 via-transparent to-transparent rounded-full blur-[100px] pointer-events-none"
        />
        ...
        <motion.div 
          ...
          className="absolute top-1/4 left-1/4 w-1 h-1 bg-[#002E5F] rounded-full blur-[1px]"
        />
        <motion.div 
          animate={{ y: [0, 20, 0], opacity: [0.1, 0.3, 0.1] }}
          transition={{ duration: 7, repeat: Infinity, ease: "easeInOut", delay: 1 }}
          className="absolute bottom-1/3 right-1/4 w-1.5 h-1.5 bg-[#003F8A] rounded-full blur-[2px]"
        />
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <div className="relative w-40 h-40 flex items-center justify-center mb-10">
            <motion.div
              ...
              className="absolute inset-0 rounded-full border-[1px] border-white/[0.03] border-t-[#002E5F]/60 border-r-[#003F8A]/40"
            />
            <motion.div
              animate={{ rotate: -360 }}
              transition={{ duration: 16, ease: "linear", repeat: Infinity }}
              className="absolute inset-[-16px] rounded-full border-[1px] border-white/[0.02] border-b-[#002E5F]/30 border-l-[#003F8A]/50"
            />
            ...
            <div className="absolute inset-2 bg-[#020617] rounded-full shadow-[inset_0_0_20px_rgba(0,180,216,0.1)] flex items-center justify-center">
              <motion.div
                ...
                className="w-14 h-14 bg-gradient-to-br from-[#003F8A] to-[#002E5F] rounded-2xl flex items-center justify-center shadow-[0_0_40px_rgba(0,180,216,0.4)] relative overflow-hidden"
              >
          ...
          >
            <div className="flex items-center justify-center gap-5 mb-4">
              ...
              <span className="font-sans font-black text-2xl tracking-[0.2em] text-[#002E5F]">KRONES</span>
            </div>
          ...
          >
            <div className="h-[2px] w-full bg-white/5 relative overflow-hidden rounded-full">
              <motion.div
                ...
                className="absolute top-0 left-0 bottom-0 bg-gradient-to-r from-transparent via-[#002E5F] to-[#002E5F] shadow-[0_0_12px_rgba(0,180,216,1)]"
              />
            </div>
            <motion.div
              animate={{ opacity: [0.3, 1, 0.3] }}
              transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
              className="mt-5 text-center text-[9px] tracking-[0.3em] text-[#002E5F] uppercase font-bold"
            >
  ...
  return (
    <div className="min-h-screen bg-[#031218] text-slate-300 font-sans selection:bg-[#12D6DF]/30 relative overflow-hidden">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        <div className="absolute top-0 right-0 w-[70vw] h-[70vh] bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-[#003F8A]/22 via-[#1D4ED8]/7 to-transparent blur-3xl" />
        <div className="absolute bottom-0 left-0 w-[50vw] h-[50vh] bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-[#60A5FA]/14 via-transparent to-transparent blur-3xl" />
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(0,63,138,0.08),transparent_25%),radial-gradient(circle_at_82%_12%,rgba(96,165,250,0.07),transparent_20%)]" />
        <div className="absolute inset-x-0 top-0 h-[320px] bg-[linear-gradient(180deg,rgba(0,63,138,0.16),rgba(3,18,24,0))]" />
      </div>
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12 h-20 flex justify-between items-center">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col justify-center">
                <span className="font-bold text-lg md:text-xl tracking-tight text-white leading-none flex items-center gap-2">
                  KRONES <span className="text-[#12D6DF] text-sm hidden sm:inline">Mobility Desk</span>
                </span>
                <span className="text-[10px] font-medium tracking-[0.24em] text-slate-400 uppercase mt-1">
                  Dedicated Krones Portal
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="hidden lg:flex items-center gap-8 h-full">
            <div className="flex items-center gap-8 h-full">
              <Link href="#booking" className={`text-sm font-medium tracking-[0.12em] uppercase hover:text-white transition-colors h-full flex items-center border-b-2 ${pathname === "/krones/bookings" ? "text-slate-500 border-transparent" : "text-slate-200 border-[#12D6DF]"}`}>
                {t('nav', 'booking')}
              </Link>
              <Link href="/krones/bookings" className={`text-sm font-medium tracking-[0.12em] uppercase hover:text-white transition-colors h-full flex items-center border-b-2 ${pathname === "/krones/bookings" ? "text-white border-[#29D391]" : "text-slate-300 border-transparent hover:border-[#12D6DF]/30"}`}>
                Foglalásaim
              </Link>
            </div>
            ...
            <div className="flex items-center gap-3 pl-2">
                <div className="hidden xl:flex flex-col items-end">
                  ...
                  <Link href="/krones/bookings" className="text-[10px] font-medium text-[#12D6DF] hover:text-[#29D391] transition-colors mt-1 flex items-center gap-1">
      ...
      <section id="booking" className="relative pt-32 pb-24 px-6 min-h-screen flex items-start justify-center z-10">
        <div className="max-w-[1200px] mx-auto w-full">
          ...
          <div className="text-center mb-12">
            <div className="relative overflow-hidden rounded-[26px] border border-[#003F8A]/20 bg-[linear-gradient(135deg,rgba(0,63,138,0.14),rgba(3,18,24,0.95)_42%,rgba(96,165,250,0.12))] px-6 py-8 md:px-10 md:py-10 shadow-[0_25px_90px_rgba(0,63,138,0.16)]">
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_var(--tw-gradient-stops))] from-[#60A5FA]/12 via-transparent to-transparent pointer-events-none" />
              <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[#60A5FA]/70 to-transparent" />
              <div className="relative">
                <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#003F8A]/10 border border-[#003F8A]/20 mb-6 shadow-[0_0_25px_rgba(0,63,138,0.08)]">
                  <ShieldCheck className="w-3.5 h-3.5 text-[#60A5FA]" />
                  <span className="text-[10px] font-bold text-[#93C5FD] tracking-[0.24em] uppercase">
                ...
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.28 }} className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-3 max-w-5xl mx-auto">
                  {portalBrand.heroHighlights.map((item) => (
                    <div key={item} className="rounded-[22px] border border-white/10 bg-white/[0.04] px-4 py-4 text-left backdrop-blur-sm">
                      <div className="text-[10px] font-black tracking-[0.2em] uppercase text-[#BFDBFE] mb-2">KRONES</div>
            ...
            >
              ...
              <div className="p-10 md:p-16 flex flex-col items-center text-center">
                ...
                >
                  ...
                  <div className="inline-flex items-center gap-3 px-6 py-3 rounded-xl bg-gradient-to-r from-[#003F8A]/20 to-[#002E5F]/15 border border-[#003F8A]/30 shadow-[0_0_25px_rgba(0,180,216,0.2)]">
                ...
                >
                  <ShieldCheck className="w-4 h-4 text-[#002E5F] shrink-0 mt-0.5" />
                ...
                >
                  <button
                    onClick={() => router.push("/krones/bookings")}
                    className="py-4 px-5 rounded-lg bg-[#003F8A] hover:bg-[#0B1F47] text-white font-bold text-sm tracking-wider uppercase transition-all duration-300 flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(0,180,216,0.3)] hover:shadow-[0_0_30px_rgba(0,180,216,0.5)]"
                  >
            ...
            >
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-3 mb-6 pb-4 border-b border-slate-800">
                  <div className="w-8 h-8 rounded-full bg-[#003F8A]/20 flex items-center justify-center text-[#002E5F] font-bold text-sm border border-[#003F8A]/30">1</div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <label className="text-[11px] text-slate-400 font-bold tracking-widest uppercase ml-1 flex gap-1">
                      Email address of the Traveler <span className="text-[#002E5F]">*</span>
                    </label>
                    <div className={`w-full bg-[#151E32] rounded-lg p-3.5 flex items-center gap-3 text-slate-300 transition-all border ${isFieldInvalid("travelerEmail") ? "border-red-500/70 ring-1 ring-red-500/20 focus-within:border-red-500 focus-within:ring-red-500/30" : "border-slate-700/50 focus-within:border-[#003F8A] focus-within:ring-1 focus-within:ring-[#003F8A]/30"}`}>
                  ...
                  <div className="space-y-2">
                    <label className="text-[11px] text-slate-400 font-bold tracking-widest uppercase ml-1 flex gap-1">
                      Name of the Traveler <span className="text-[#002E5F]">*</span>
                    </label>
                    <div className={`w-full bg-[#151E32] rounded-lg p-3.5 flex items-center gap-3 text-slate-300 transition-all border ${isFieldInvalid("travelerName") ? "border-red-500/70 ring-1 ring-red-500/20 focus-within:border-red-500 focus-within:ring-red-500/30" : "border-slate-700/50 focus-within:border-[#003F8A] focus-within:ring-1 focus-within:ring-[#003F8A]/30"}`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="w-full bg-[#151E32] border border-slate-700/50 rounded-lg p-3.5 flex items-center gap-3 text-slate-300 focus-within:border-[#003F8A] focus-within:ring-1 focus-within:ring-[#003F8A]/30 transition-all">
                      <Briefcase className="w-4 h-4 text-slate-500" />
                      <input type="text" defaultValue="Krones AG" readOnly className="bg-transparent border-none outline-none w-full text-sm font-bold text-white opacity-80 cursor-not-allowed" />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    <label className="text-[11px] text-slate-400 font-bold tracking-widest uppercase ml-1 flex gap-1">
                      Phone number (only digit / 0123456789) <span className="text-[#002E5F]">*</span>
                    </label>
                    <div className={`w-full bg-[#151E32] rounded-lg p-3.5 flex items-center gap-3 text-slate-300 transition-all border ${isFieldInvalid("travelerPhone") ? "border-red-500/70 ring-1 ring-red-500/20 focus-within:border-red-500 focus-within:ring-red-500/30" : "border-slate-700/50 focus-within:border-[#003F8A] focus-within:ring-1 focus-within:ring-[#003F8A]/30"}`}>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-3 mb-6 pb-4 border-b border-slate-800">
                  <div className="w-8 h-8 rounded-full bg-[#003F8A]/20 flex items-center justify-center text-[#002E5F] font-bold text-sm border border-[#003F8A]/30">2</div>
                  <h3 className="text-white font-semibold text-lg tracking-wide">Fizetés és Típus</h3>
                </div>

                <div className="space-y-2">
                  <label className="text-[11px] text-slate-400 font-bold tracking-widest uppercase ml-1 flex gap-1">
                    Payment Method <span className="text-[#002E5F]">*</span>
                  </label>
                  <div className="grid grid-cols-2 gap-4">
                    <button 
                      ...
                      className={`py-3.5 px-4 rounded-lg flex items-center justify-center gap-2 border transition-all ${
                        paymentMethod === "card" 
                          ? "bg-[#003F8A]/20 border-[#003F8A] text-white" 
                          : "bg-[#151E32] border-slate-700/50 text-slate-400 hover:border-slate-500"
                      }`}
                    >
                      <CreditCard className={`w-4 h-4 ${paymentMethod === "card" ? "text-[#002E5F]" : ""}`} />
                    ...
                    >
                      <Building className={`w-4 h-4 ${paymentMethod === "bank" ? "text-[#002E5F]" : ""}`} />
                ...
                <div className="space-y-2">
                  <label className="text-[11px] text-slate-400 font-bold tracking-widest uppercase ml-1 flex gap-1">
                    Transfer Type <span className="text-[#002E5F]">*</span>
                  </label>
                  <div className="grid grid-cols-2 gap-4">
                    <button 
                    ...
                    <button 
                      ...
                      className={`py-3.5 px-4 rounded-lg flex flex-col items-center justify-center gap-1 border transition-all ${
                        transferType === "executive" 
                          ? "bg-gradient-to-br from-[#003F8A]/30 to-[#002E5F]/20 border-[#003F8A] text-white shadow-[0_0_15px_rgba(0,180,216,0.2)]" 
                          : "bg-[#151E32] border-slate-700/50 text-slate-400 hover:border-slate-500"
                      }`}
                    >
                      <span className="text-sm font-bold text-[#002E5F]">Executive</span>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-3 mb-6 pb-4 border-b border-slate-800">
                  <div className="w-8 h-8 rounded-full bg-[#003F8A]/20 flex items-center justify-center text-[#002E5F] font-bold text-sm border border-[#003F8A]/30">3</div>
                ...
                <div className="space-y-4 bg-[#0F172A]/50 p-6 rounded-xl border border-slate-800/50">
                  ...
                  <div className="space-y-2 pt-2">
                    <label className="text-[11px] text-slate-400 font-bold tracking-widest uppercase ml-1 flex gap-1">
                      From Address <span className="text-[#002E5F]">*</span>
                    </label>
                    <div className={`w-full bg-[#151E32] rounded-lg p-3.5 flex items-center gap-3 text-slate-300 transition-all border ${isFieldInvalid("fromAddress") ? "border-red-500/70 ring-1 ring-red-500/20 focus-within:border-red-500 focus-within:ring-red-500/30" : "border-slate-700/50 focus-within:border-[#003F8A] focus-within:ring-1 focus-within:ring-[#003F8A]/30"}`}>
                      ...
                      <input
                        ...
                        placeholder={fromType === "airport" ? "e.g. Budapest Airport (BUD)" : "e.g. KRONES Debrecen Gyár..."}
                        className="bg-transparent border-none outline-none w-full text-sm font-medium placeholder:text-slate-600 text-white"
                      />
                    </div>
                ...
                <div className="space-y-4 bg-[#0F172A]/50 p-6 rounded-xl border border-slate-800/50">
                  ...
                  <div className="space-y-2 pt-2">
                    <label className="text-[11px] text-slate-400 font-bold tracking-widest uppercase ml-1 flex gap-1">
                      To Address <span className="text-[#002E5F]">*</span>
                    </label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-[11px] text-slate-400 font-bold tracking-widest uppercase ml-1 flex gap-1">
                      When (Date) <span className="text-[#002E5F]">*</span>
                    </label>
                    <div className={`w-full bg-[#151E32] rounded-lg p-3.5 flex items-center justify-between text-slate-300 transition-all border ${isFieldInvalid("pickupDate") ? "border-red-500/70 ring-1 ring-red-500/20 focus-within:border-red-500 focus-within:ring-red-500/30" : "border-slate-700/50 focus-within:border-[#003F8A] focus-within:ring-1 focus-within:ring-[#003F8A]/30"}`}>
                      <input
                        type="date"
                        value={pickupDate}
                  ...
                  <div className="space-y-2">
                    <label className="text-[11px] text-slate-400 font-bold tracking-widest uppercase ml-1 flex gap-1">
                      Time <span className="text-[#002E5F]">*</span>
                    </label>
                    <div className={`w-full bg-[#151E32] rounded-lg p-3.5 flex items-center justify-between text-slate-300 transition-all border ${isFieldInvalid("pickupTime") ? "border-red-500/70 ring-1 ring-red-500/20 focus-within:border-red-500 focus-within:ring-red-500/30" : "border-slate-700/50 focus-within:border-[#003F8A] focus-within:ring-1 focus-within:ring-[#003F8A]/30"}`}>
                      <input
                        type="time"
                        value={pickupTime}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <label className="text-[11px] text-slate-400 font-bold tracking-widest uppercase ml-1 flex gap-1">
                      Number of the Travelers <span className="text-[#002E5F]">*</span>
                    </label>
                  ...
                  <div className="space-y-2">
                    <label className="text-[11px] text-slate-400 font-bold tracking-widest uppercase ml-1 flex gap-1">
                      Number of the luggage <span className="text-[#002E5F]">*</span>
                    </label>
                    <div className="w-full bg-[#151E32] border border-slate-700/50 rounded-lg p-2.5 flex justify-between items-center text-white">
                      <div className="flex items-center gap-3 px-2">
                ...
                <div className="space-y-2">
                  ...
                  <div className="w-full bg-[#151E32] border border-slate-700/50 rounded-lg p-3.5 focus-within:border-[#003F8A] focus-within:ring-1 focus-within:ring-[#003F8A]/30 transition-all">
                    <textarea
                      rows={3}
                      value={commentText}
              ...
              <div className="pt-6 border-t border-slate-800">
                <button
                  ...
                  className={`w-full rounded-lg font-bold text-sm tracking-widest uppercase transition-all duration-300 flex justify-center items-center gap-3 py-4.5 ${
                    formLoading
                      ? "bg-[#003F8A]/60 text-white/80 cursor-not-allowed shadow-[0_0_15px_rgba(0,180,216,0.15)]"
                      : "bg-[#003F8A] hover:bg-[#0B1F47] text-white shadow-[0_0_20px_rgba(0,180,216,0.3)] hover:shadow-[0_0_30px_rgba(0,180,216,0.5)]"
                  }`}
                >
                  {formLoading ? (
                    <>
          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex flex-col text-center md:text-left">
              <span className="font-bold text-white tracking-wide text-sm leading-none flex items-center gap-2">
                KRONES <span className="text-xs font-normal text-slate-400">{t('footer', 'portal')}</span>
              </span>
            </div>
          </div>
