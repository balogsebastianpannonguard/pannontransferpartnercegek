...
export default function KronesLandingPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const res = await fetch("/api/krones-auth/session", {
          cache: "no-store",
        });
        if (!active) return;
        if (res.ok) {
        ...
        <div className="w-full border-t border-zinc-200/70 bg-white/60 backdrop-blur-md mt-auto">
          <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between text-[11px] text-zinc-400 font-medium">
            ...
            <span className="tracking-wider">
              KRONES Dedikált Ügyfélportál · Kizárólagos linkalapú hozzáférés
            </span>
          </div>
        </div>
      </div>
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          >
            <div className="flex items-center justify-center gap-5 mb-4">
              ...
              <span className="font-sans font-black text-2xl tracking-[0.2em] text-[#002E5F]">
                KRONES
              </span>
            </div>
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12 h-20 flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center gap-8 h-full">
            <div className="flex items-center gap-8 h-full">
              <Link
                href="#booking"
                className={`text-sm font-medium tracking-[0.12em] uppercase hover:text-white transition-colors h-full flex items-center border-b-2 ${pathname === "/krones/bookings" ? "text-slate-500 border-transparent" : "text-slate-200 border-[#12D6DF]"}`}
              >
                {t("nav", "booking")}
              </Link>
              <Link
                href="/krones/bookings"
                className={`text-sm font-medium tracking-[0.12em] uppercase hover:text-white transition-colors h-full flex items-center border-b-2 ${pathname === "/krones/bookings" ? "text-white border-[#29D391]" : "text-slate-300 border-transparent hover:border-[#12D6DF]/30"}`}
              >
                Foglalásaim
              </Link>
            </div>
      ...
      >
        <div className="max-w-[1200px] mx-auto w-full">
          ...
          <div className="text-center mb-12 flex justify-center w-full">
            <img
              src="/partners/krones/hero-logo.png"
              alt="Krones Logo"
              ...
              <div className="p-8 md:p-12 space-y-10">
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-3 mb-6 pb-4 border-b border-slate-800">
                    <div className="w-8 h-8 rounded-full bg-[#003F8A]/20 flex items-center justify-center text-[#002E5F] font-bold text-sm border border-[#003F8A]/30">
                      1
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <label className="text-[11px] text-slate-400 font-bold tracking-widest uppercase ml-1 flex gap-1">
                        ...
                        <span className="text-[#002E5F]">*</span>
                      </label>
                      <div
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      >
                        <CreditCard
                          className={`w-4 h-4 ${paymentMethod === "card" ? "text-[#002E5F]" : ""}`}
                        />
                      ...
                      >
                        <Building
                          className={`w-4 h-4 ${paymentMethod === "bank" ? "text-[#002E5F]" : ""}`}
                        />
                        <span className="text-sm font-bold">
                          Bank Transaction
                        </span>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      >
                        <span className="text-sm font-bold text-[#002E5F]">
                          Executive
                        </span>
                        <span className="text-[10px] opacity-70">
                          Business Class
